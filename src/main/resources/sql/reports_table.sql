...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `target_id` BIGINT NOT NULL COMMENT '被举报对象 ID（话题 ID、评论 ID、商品 ID、地点 ID）',
  `target_type` VARCHAR(20) NOT NULL COMMENT '被举报类型：topic-话题、comment-评论、product-商品、location-地点',
  `report_type` VARCHAR(50) NOT NULL COMMENT '举报类型：pornography-色情低俗、illegal-违法犯罪、political-政治敏感、spam-垃圾广告、fake_info-虚假信息、copyright-侵权内容、harassment-人身攻击、other-其他',
  `reason` TEXT COMMENT '举报原因描述',
  `evidence` TEXT COMMENT '证据（包含图片和其他证据）',
